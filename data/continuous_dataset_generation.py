...
#----------------constants--------------
path_to_360_images = 'all_images_new/*.jpg'
...
for image360_path in list_360_image_paths: #length of your filename list
    ...
    for i in range(30): #was 30
        ...
        #cv2.imshow('image',im)
        #cv2.waitKey(0)
        cv2.imwrite('/home/ihor_leshchyshyn/Deep/dataset_continuous/' + name_list[0] +'_f_'+str(f)+'_d_'+str(xi)+ '.' +name_list[-1], im)
        #cv2.imwrite('/Users/ihor_leshchyshyn/Desktop/dataset_continuous/' + name_list[0] +'_f_'+str(f)+'_d_'+str(xi)+ '.' +name_list[-1], im) #Changed
